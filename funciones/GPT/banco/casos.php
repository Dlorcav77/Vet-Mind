...
<p style="text-align: justify;"><span style="color: windowtext;"><strong>Riñón izquierdo</strong> posición normal, forma ovalada, tamaño conservado de XX cm, bordes regulares, límite cortico medular definido, relación cortico medular conservada y ecogenicidad cortical y medular conservada, Vasculatura normal. Pelvis conservada. No se visualiza uréter.</span></p>
<p style="text-align: justify;"><span style="color: windowtext;"><strong>Riñón derecho</strong> posición normal, forma ovalada, tamaño conservado de XX cm, bordes regulares, límite cortico medular definido, relación cortico medular conservada y ecogenicidad cortical y medular conservada, Vasculatura normal. Pelvis conservada. No se visualiza uréter.</span></p>
...
<p style="text-align: justify;"><span style="color: windowtext;"><strong>Gastro entero</strong>: <em>Estómago</em> con patrón alimenticio, pared conservada de XX cm, estratificación conservada. <em>Duodeno</em> en patrón mucoso, estratificación conservada, pared conservada de XX cm. <em>Yeyuno</em> en patrón mucoso, pared conservada de XX cm, estratificación conservada. <em>Colon</em> con contenido fecal sólido, pared conservada de XX cm.</span></p>
<p><span style="color: windowtext;"><strong>Páncreas </strong>de tamaño y parénquima conservado en su rama derecha.</span></p>
<p style="text-align: justify;"><span style="color: windowtext;"><strong>Linfonódulos</strong></span> <span style="color: windowtext;">no se observan LN reactivos.</span></p>
<p style="text-align: justify;"><span style="color: windowtext;"><strong>Glándulas adrenales:</strong> AI de tamaño conservado de XX cm en su polo caudal, forma y ecogenicidad conservada. AD de tamaño conservado de XX cm en su polo caudal, forma y ecogenicidad conservada.</span><br></p>
