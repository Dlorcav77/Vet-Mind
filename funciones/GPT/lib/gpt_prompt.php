...
function gpt_build_prompt(mysqli $mysqli, array $input): array
{
    ...
    $system = <<<'SYS'
      ...
      - Si el DICTADO trae un órgano o hallazgo que no está en la PLANTILLA, intégralo en su posición anatómica correcta, NO al final por defecto:
        ...
        - Íleon: párrafo propio entre Yeyuno y Colon, con Íleon en cursiva al inicio.
      ...
      - Un órgano con posición conocida (próstata, testículos, reproductivo hembra, íleon) NUNCA va en HALLAZGOS ADICIONALES.
      - En la sección digestiva, cada órgano (Estómago, Duodeno, Yeyuno, Colon, e Íleon si aplica) va en su propio párrafo, con el nombre en cursiva. No los unifiques.
      ...
      - "MISMAS CARACTERÍSTICAS": si el DICTADO dice que un órgano tiene "mismas características" que otro, NUNCA escribas literalmente "mismas características". Copia explícitamente todos los atributos del órgano de referencia y aplica solo los cambios que el DICTADO indique para este (ej. su propio tamaño). Redáctalo completo.
      - LATERALIDAD: respétala estrictamente. Un dato "renal izquierda" solo va en la sección renal izquierda; "adrenal derecha" solo en adrenal derecha; etc. Nunca uses un valor de la PLANTILLA para reemplazar un valor distinto del DICTADO en el mismo órgano.
