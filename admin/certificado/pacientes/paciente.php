...
?>
<link rel="stylesheet" href="certificado/pacientes/css/paciente.css?v=<?= vetmind_asset_version() ?>">
...
<script src="certificado/pacientes/js/paciente.js?v=<?= vetmind_asset_version() ?>"></script>