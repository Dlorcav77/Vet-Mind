...
<div
    class="modal fade"
    id="modalDetalleTutorManual"
    tabindex="-1"
    aria-labelledby="modalDetalleTutorManualLabel"
    aria-hidden="true"
>
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <div>
                    <h5
                        ...
                        id="modalDetalleTutorManualLabel"
                    >
                        Tutor
                    </h5>
            ...
            <div class="modal-body">
                <div
                    class="manual-tutor-modal-mascotas"
                    id="modalDetalleTutorMascotas"
                ></div>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button
                    type="button"
                    class="btn btn-info btn-usar-tutor-modal"
                >
